...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in BootCommand) DeepCopyInto(out *BootCommand) {
	{
		in := &in
		*out = make(BootCommand, len(*in))
		copy(*out, *in)
	}
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new BootCommand.
func (in BootCommand) DeepCopy() BootCommand {
	if in == nil {
		return nil
	}
	out := new(BootCommand)
